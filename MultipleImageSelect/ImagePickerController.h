...
@protocol ImagePickerControllerDelegate <UINavigationControllerDelegate>
...
@interface ImagePickerController : UINavigationController <AssetSelectionDelegate>

@property (nonatomic, weak) id<ImagePickerControllerDelegate> imagePickerDelegate;
